            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-10">
                          <h3 class="card-title mt-2">Rencana Kerja (Renja)</h3>
                        </div>
 ...
 Tambah</button>
                ...
                <div class="card-body">
                  <table id="table" class="table table-bordered table-striped">
                    ...
                    <tr>
                      <td>#</td>
                      <td><b>Renja Kerja (Renja) Perangkat Daerah Tahun 2022</b><br>Periode Pemerintahan : <b>2021-2026</b> Jumlah Perangkat Daerah : <b>47</b></td>
                      <td>pie chart</td>
                      <td>
