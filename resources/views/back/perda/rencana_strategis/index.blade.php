            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-10">
                          <h3 class="card-title mt-2">Rencana Strategis (Renstra)</h3>
                        </div>
 ...
 Tambah</button>
                ...
                <div class="card-body">
                  <table id="table" class="table table-bordered table-striped">
                    ...
                    <tr>
                      <th>No.</th>
                      <th>Rencana Strategis (Renstra)</th>
                    ...
                    <tr>
                      <td>#</td>
                      <td><b>Rencana Strategis (Renstra) Periode Pemerintahan 2016-2021</b><br>Jumlah Perangkat Daerah : <b>0</b></td>
                      <td>pie chart</td>
                      <td>
