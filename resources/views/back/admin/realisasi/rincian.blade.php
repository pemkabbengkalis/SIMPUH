            ...
            <div class="col-12">
              <div class="card">
               ...
               <table class="table-bordered table-striped table-hover" style="width:2500px;font-size:small">
                <thead>
                    <tr>
                        <th rowspan="3" style="vertical-align:middle" class="text-center">Program Unggulan</th>
...
@endforeach
                    ...
                    <tr class="bg-dark">
                        ...
                        <td  align="center" class="bold">{{isset($pk) ? round(array_sum($pk) / count($pk)) : null}}</td>
                        <td  align="center" class="bold">{{isset($pk) ? round(array_sum($prp) / count($prp)): null}}</td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td colspan="14" align="right"><b>Prediket Kinerja</b></td>
                        <td  align="center" class="bold">{{isset($pk) ? prediket(round(array_sum($pk) / count($pk))): null}}</td>
                        <td  align="center" class="bold">{{isset($pk) ? prediket(round(array_sum($prp) / count($prp))): null}}</td>
                        <td></td>
                        <td></td>
                    </tr>
                </tbody>
