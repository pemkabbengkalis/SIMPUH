                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="kode_program" value="{{$edit->kode_program ?? null}}" placeholder="Kode Sub Program" required>
                        </div>
                        <div class="form-group">
                          <label for="">Nama  Program</label>
                          <input type="text" class="form-control" name="nama_program" value="{{$edit->nama_program ?? null}}" placeholder="Nama Sub Program" required>
                        </div>
                        @if(!empty($data))
                         <div class="form-group">
