                    ...
                    <tr>
                      ...
                      <td>
                          <center>
                            ...
                            <a href="{{url(modul('path').'/delete/'.en($row->id_sub_kegiatan))}}" class="btn btn-danger btn-xs" onclick="return confirm('Yakin akan menghapus data ini?')"><i class="fa fa-trash" aria-hidden="true" ></i></a>
                          </center>
                      </td>
                    </tr>
                    @endforeach
